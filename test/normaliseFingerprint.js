...
describe("Normalise Fingerprint", function() {
  it("should remove fingerprints from file names", function() {
    let assets = { 'dist/assets/auto-import-fastboot-12a5d6f444be918dea6cd3914e6c0fc7.js': { raw: 221142, gzip: 76707, brotli: null },
     ...
     let normalisedAssets = normaliseFingerprint(assets);
